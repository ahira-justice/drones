...
public class HeavyweightDroneMaxWeightResolverImpl implements DroneMaxWeightResolver {

    private final AppProperties appProperties;

    @Override
    public boolean canResolve(DroneModel droneModel) {
        return DroneModel.HEAVYWEIGHT.equals(droneModel);
    }

    @Override
    public Weight resolve() {
        return Weight.builder()
                .weight(appProperties.getHeavyweightDroneMaxWeight())
                .weightUnit(appProperties.getHeavyweightDroneMaxWeightUnit())
                .build();
    }
