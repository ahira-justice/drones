...
public class LightweightDroneMaxWeightResolverImpl implements DroneMaxWeightResolver {

    private final AppProperties appProperties;

    @Override
    public boolean canResolve(DroneModel droneModel) {
        return DroneModel.LIGHTWEIGHT.equals(droneModel);
    }

    @Override
    public Weight resolve() {
        return Weight.builder()
                .weight(appProperties.getLightweightDroneMaxWeight())
                .weightUnit(appProperties.getLightweightDroneMaxWeightUnit())
                .build();
    }
